...
namespace MSBuild.ExtensionPack.BizTalk
{
    ...
    /// ]]></code>    
    /// </example>
    [HelpUrl("http://www.msbuildextensionpack.com/help/3.5.4.0/html/39023295-c104-8b83-0904-d7b2485f6d63.htm")]
    public class BizTalkSendHandler : BaseTask
    {
        ...
        private void Create()
        {
            ...
            ManagementClass instance = new ManagementClass(this.Scope, new ManagementPath("MSBTS_SendHandler2"), null);
        ...
        private void Delete()
        {
            ...
            ManagementObjectSearcher searcher = new ManagementObjectSearcher(this.Scope, query, null);
            ManagementObjectCollection objects = searcher.Get();
            ManagementObject newDefault = new ManagementObject();
